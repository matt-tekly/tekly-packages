...
namespace Tekly.Common.Maths
{
	...
	public sealed class NumericRangePropertyDrawer : PropertyDrawer
	{
		...
		private static void DrawFloatRangeWithLimits(Rect position, SerializedProperty minProp,
			SerializedProperty maxProp, RangeLimitsAttribute limits)
		{
			var h = EditorGUIUtility.singleLineHeight;
		...
		private static void DrawIntRangeWithLimits(Rect position, SerializedProperty minProp,
			SerializedProperty maxProp, RangeLimitsAttribute limits)
		{
			var h = EditorGUIUtility.singleLineHeight;
